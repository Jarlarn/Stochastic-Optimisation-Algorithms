...
def main():
    ...
    p.add_argument(
        "--slope", type=int, default=8, help="Slope index to run (default: 0)"
    )
    p.add_argument(
        "--data-set", type=int, default=1, help="Data set index (default: 3 = test set)"
    )
    p.add_argument(
        "--best-py",
        default="best_chromosome2.py",
